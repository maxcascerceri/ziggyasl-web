// Every marketing string lives here — edit this file, not the components.
...
export const copy = {
  ...
  why: {
    title: "Why people stay with Ziggy",
    items: [
      {
        title: "Video-first ASL",
        body: "Learn from real signing, not diagrams.",
        tint: "blue",
      },
      {
        title: "Short daily sessions",
        body: "Lessons fit into a coffee break.",
        tint: "mint",
      },
      {
        title: "Progress you can see",
        body: "Every day adds up — and it shows.",
        tint: "peach",
      },
    ],
  },
